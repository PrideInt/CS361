 ...
 * 
 */
package cs361languages.src.employee;
...
//		PartTimeEmployee pEmp2 = new PartTimeEmployee("Melissa", "Will", "123456666", 23.5);
		...
		/**
		 * Because we do not have a defined function #getHourlyRate in Employee
		 */
		...
		/**
		 * This instruction does not compile because an Employee reference cannot be cast
		 * to PartTimeEmployee (its inherited subclass). Employee is PartTimeEmployee's parent
		 * class.
		 */
